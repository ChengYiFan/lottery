...
var lottery = (function($){
	...
	*/
	loadPeople = function(obj,timer){
		var ul = obj.find('.candidate'), flag = obj.hasClass('third');
	...
	*/
	...
	showLucky = function(){
		var current = configMap.current.attr('class');
		if(current == 'first'){
			configMap.winRight.showFirst(configMap.timer);
		}else if(current == 'second'){
			configMap.winRight.showSecond(configMap.timer);
		}else if(current == 'third'){
			configMap.winLeft.showThird(configMap.timer,configMap.thirdCon);
		}	
